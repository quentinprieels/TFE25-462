...
class reciever_rfnoc(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Reciever with RFNoC", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Reciever with RFNoC")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "reciever_rfnoc")
        ...
        self.uhd_rfnoc_rx_radio_0 = uhd.rfnoc_rx_radio(
            self.rfnoc_graph,
            uhd.device_addr('type=x300'),
            (-1),
            (-1))
        self.uhd_rfnoc_rx_radio_0.set_rate(samp_rate)
        self.uhd_rfnoc_rx_radio_0.set_antenna('RX1', 0)
        self.uhd_rfnoc_rx_radio_0.set_gain(usrp_gain, 0)
        self.uhd_rfnoc_rx_radio_0.set_bandwidth(0, 0)
        self.uhd_rfnoc_rx_radio_0.set_frequency(usrp_center_freq, 0)
        ...
        self.uhd_rfnoc_ddc_0.set_output_rate(0, 0)
        ...
        self.rfnoc_graph.connect(self.uhd_rfnoc_rx_radio_0.get_unique_id(), 0, self.uhd_rfnoc_ddc_0.get_unique_id(), 0, False)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.digital_ofdm_sync_sc_cfb_0, 0))
        ...
        self.connect((self.uhd_rfnoc_rx_streamer_0, 0), (self.blocks_throttle2_0, 0))
    ...
    def set_usrp_gain(self, usrp_gain):
        ...
        self.uhd_rfnoc_rx_radio_0.set_gain(self.usrp_gain, 0)
    ...
    def set_usrp_center_freq(self, usrp_center_freq):
        ...
        self.uhd_rfnoc_rx_radio_0.set_frequency(self.usrp_center_freq, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.uhd_rfnoc_rx_radio_0.set_rate(self.samp_rate)
...
def main(top_block_cls=reciever_rfnoc, options=None):
