...
class reciever_uhdsink(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Reciever with UHD Sink", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Reciever with UHD Sink")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "reciever_uhdsink")
        ...
        self.uhd_usrp_source_0.set_center_freq(usrp_center_freq, 0)
    ...
    def set_usrp_center_freq(self, usrp_center_freq):
        ...
        self.uhd_usrp_source_0.set_center_freq(self.usrp_center_freq, 0)
...
def main(top_block_cls=reciever_uhdsink, options=None):
